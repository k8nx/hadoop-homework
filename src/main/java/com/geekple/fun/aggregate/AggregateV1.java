...
public class AggregateV1 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(AggregateV1.class);
		job.setJobName("AggregateV1");
		...
		FileOutputFormat.setOutputPath(job, new Path("/geekple/output/aggregate/v1"));
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new AggregateV1(), args);
